...
parser.add_argument('-b', '--bin-width', dest='binwidth', type=float, default=20)
...
if __name__ == '__main__':
    ...
    qla_data = get_qla_data(args.night, bin_width_minutes=args.binwidth, db=db)
    plot_qla(qla_data, args.outputfile)
